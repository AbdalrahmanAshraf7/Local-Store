...
export default function LogIn() {
    ...
    console.log(Token,"TTTTTTTTTTTTTTTTT")
        let nav = useNavigate()
...
<div className="flex min-h-screen items-center justify-center">
  <div className="relative flex flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none p-7 bg-slate-100">
    <h4 className=" text-center font-bold font-serif  block text-2xl leading-snug tracking-normal text-blue-gray-900 antialiased">
      Log In
    </h4>
